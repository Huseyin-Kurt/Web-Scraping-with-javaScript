...
const ikinciKisimEkrani=document.querySelector("#ikinciKisimEkrani");

//ikinci kisim fonksiyonları

function ikinciKisimFonksiyonu() 
{	
	let url=prompt("Url giriniz?(Anahtar kelime tespiti)");

	while(url===null)
	{
		url=prompt("Url giriniz?(Anahtar kelime tespiti)");
	}
...
function anahtarKelimeBulma(frekansDizisi,kelimeler)
{
	...
	sonuclariYazdirma(anahtarKelimeler);

}


function sonuclariYazdirma(anahtarKelimeler)
{
	const ikinciKisimSonuclari=document.createElement("div");
	ikinciKisimSonuclari.id="ikinciKisimSonuclari";

	anahtarKelimeler.map((mevcutAnahtar,indis)=>
		{
			let yeniParagraf=document.createElement("p");
			yeniParagraf.className="ikinciKisimYeniParagraf";

			let yeniParagrafYazisi=document.createTextNode(indis+".\t"+mevcutAnahtar.string+"\t("+mevcutAnahtar.skor+")");

			yeniParagraf.appendChild(yeniParagrafYazisi);
			ikinciKisimSonuclari.appendChild(yeniParagraf);
		});


	ikinciKisimEkrani.appendChild(ikinciKisimSonuclari);
}


ikinciKisimFonksiyonu();
